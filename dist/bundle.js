  ...
  _createClass(BlogPosts, [{
    ...
    value: function createBlogPosts() {
      ...
      this.blogPostsArray.forEach(function (item) {
        ...
        var metaHeaderContainer = document.createElement('div');
        ...
        var createdLabel = document.createElement('p');
...
},{"../service/blogservice":6}],4:[function(require,module,exports){
'use strict';
...
var Pagination = exports.Pagination = function () {
  function Pagination(numberOfBlogPosts) {
    var _this = this;
    ...
    this.prevPageHandler = function (event) {
      ...
      if (_this.index > 1) {
        ...
        _this.index--;
        console.log('prev Index', _this.index);
        ...
        if (_this.index === 1) {
          var nextIcon = paginationlinks[0];
          nextIcon.classList.add('disabled');
        }
        // if we arent on last page
        if (_this.index < _this.maxPageNumber) {
          var _nextIcon2 = paginationlinks[paginationlinks.length - 1];
          _nextIcon2.classList.remove('disabled');
        }
      }
    };
  }
  ...
  _createClass(Pagination, [{
    ...
    value: function createPagination() {
      ...
      for (var i = 1; i <= this.maxPageNumber; i++) {
...
var _blogPosts = require('./js/blogPosts');
...
function init() {
  ...
  var blogEntriy = new _blogPosts.BlogPosts();
  blogEntriy.createBlogPosts();
  var pagination = new _pagination.Pagination(blogEntriy.blogPostsArray.length);
...
function postNewBlogEntry() {
  var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'http://localhost:8080/newBlogEntry';
  ...
  (0, _nodeFetch2.default)(url, options).then(function (response) {
...
},{"./js/blogPosts":3,"./js/pagination":4,"node-fetch":2}],6:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Blogservice = undefined;
...
var Author = function Author(name, avatarUrl) {
...
var BlogPost = function BlogPost(_ref, _ref2, _ref3) {
...
var Blogservice = exports.Blogservice = function () {
  ...
  _createClass(Blogservice, [{
    key: 'createTestData',
    value: function createTestData() {
      for (var i = 0; i < 30; i++) {
        var staticBlogPost = new BlogPost({
          title: 'TestTitle' + i,
          text: 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.',
          img: 'https://via.placeholder.com/600'
        }, { created: moment().startOf(moment(Date.now()).format('DD.MM.YYYY, h:mm:ss ')).fromNow() }, { name: 'Kevin', avatarUrl: 'https://via.placeholder.com/100' });
        this.blogPosts[i] = staticBlogPost;
      }
    }
  }, {
    key: 'getBlogEntries',
    value: function getBlogEntries() {
      (0, _nodeFetch2.default)('http://localhost:8080/getBlogentries', {
